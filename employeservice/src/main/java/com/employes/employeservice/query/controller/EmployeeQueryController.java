...
public class EmployeeQueryController {
	...
	public List<EmployeeReponseModel> getAllEmployee() {
		GetAllEmployQuery getallEmployeesQuery = new GetAllEmployQuery();
		List<EmployeeReponseModel> employeeReponseModel = queryGateway.query(getallEmployeesQuery, ResponseTypes.multipleInstancesOf(EmployeeReponseModel.class)).join();
		return employeeReponseModel;
